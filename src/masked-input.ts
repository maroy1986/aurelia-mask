...
const OneTimeBindingMode = { defaultBindingMode: bindingMode.oneTime, defaultValue: false };
...
export class MaskedInput {
  ...
  @bindable(OneTimeBindingMode) bindMasking: boolean
  @bindable(OneTimeBindingMode) aspnetMasking: boolean
